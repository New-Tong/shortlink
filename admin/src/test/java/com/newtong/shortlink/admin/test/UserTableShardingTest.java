package com.newtong.shortlink.admin.test;
...
public class UserTableShardingTest {
    public static final String SQL = "CREATE TABLE `t_user_%d`  (\n" +
            ...
            ") ENGINE = InnoDB AUTO_INCREMENT = 1818200816931115009 CHARACTER SET = utf8mb4;";

    public static void main(String[] args) {
        for (int i = 0; i < 16; i++) {
            System.out.println(SQL.replaceAll("%d", String.valueOf(i)));
        }
    }
}
